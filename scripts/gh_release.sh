...
LATEST_REMOTE_TAG="v$(git ls-remote --tags --refs --sort='v:refname' https://github.com/empoweristsit/bw_web_builds.git 'v*' | tail -n1 | grep -Eo '[^\/v]*$')"
...
${CONTAINER_CMD} create --name "bw_web_${IMAGE_RELEASE_TAG}" "ghcr.io/empoweristsit/bw_web_builds:${IMAGE_RELEASE_TAG}"
